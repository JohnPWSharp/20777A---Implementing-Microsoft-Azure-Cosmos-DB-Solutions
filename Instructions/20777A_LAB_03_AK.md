...
7.  In Internet Explorer, in the Azure Portal, click **+ Create a resource**.
...
11.  On the **Create storage account** blade, in the **Name** box, type **20777blob\<your name\>\<the day\>**, for example, **20777blobjohn31**.

12.  In the **Account kind** box, click **Blob storage**.

13.  In the **Location** drop-down list, click the region closest to your current location.

14.  In the **Replication** box, click **Locally-redundant storage (LRS)**.

15.  In the **Resource group** box, type **20777\_Mod03**, and then click **Create**.

16. In the Azure Portal, click **All resources**, click **Refresh**, and then click **20777blob\<your name\>\<the day\>**.

17. On the **20777blob\<your name\>\<the day\>** blade, under **BLOB SERVICE**, click **Blobs**.

18. On the **Blobs** blade, click **+ Container**.

19. In the **New container** dialog box, in the **Name** box, type **20777-mod3-blobs**.

20. In the **Public access level** drop-down list, click **Blob (anonymous read access for blobs only)**, and then click **OK**.

21. On the **20777blob\<your name\>\<the day\>** blade, under **SETTINGS**, click **Access keys**.

22. Under **key1**, make a note of the **Connection string** value.

23.  In Internet Explorer, in the Azure Portal, click **+ Create a resource**.

24.  On the **New** blade, in the search box, type **Cosmos DB**, and then press Enter.

25.  On the **Everything** blade, click **Azure Cosmos DB**, and then click **Create**.

26.  On the **Azure Cosmos DB** blade, in the **ID** box, type **20777-sql-\<your name\>-\<the day\>**, for example, **20777-sql-john-31**.

27.  In the **API** drop-down list, note the options available, and then click **SQL**.

28.  Under **Resource Group**, click **Use existing**, and then in the drop-down list, click **20777\_Mod03**.

29.  In the **Location** drop-down list, click the region closest to your current location, and then click **Create**.

30.  Wait for the Azure Cosmos DB to be created—this could take a few minutes.

31.  In the Azure Portal, click **All resources**, click **Refresh**, and then click **20777-sql-\<your name\>-\<the day\>**.

32. On the **20777-sql-\<your name\>-\<the day\>** blade, click **Data Explorer**.

33. In the **SQL API** pane, click **New Database**.

34. On the **New Database** blade, in the **Database id** box, type **Adventure-Works**, and then click **OK**.

35. On the **20777-sql-\<your name\>-\<the day\>** blade, under **SETTINGS**, click **Keys**.

36. Make a note of the **URI**, and **PRIMARY KEY** values.
...
6.  Scroll down to the **CancelBackorderAsync** method at the end of the class. In this method, after the comment **// TODO: Save the backorder, and fire the AuditOrder post-trigger** (line 220), type the following code:
    ```csharp
    if (await (Repository<ProductBackorder>.UpsertItemAsync(backorderToCancel, postTriggers: new List<string> { "AuditOrder" })))
    {
