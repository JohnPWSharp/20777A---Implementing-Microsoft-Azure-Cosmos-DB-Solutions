...
1. In the Azure portal in Internet Explorer, on the **20777a-sql-\<*your name\>-\<the day*\>** blade, click **Data Explorer**.
...
13. At the command prompt, after **Password:**, type **adm1n**, and then press Enter.
