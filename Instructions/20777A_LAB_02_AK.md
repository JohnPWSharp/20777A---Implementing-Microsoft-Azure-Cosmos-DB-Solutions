...
15. In the **Resource group** box, type **20777\_Mod02**, and then click **Create**.

16. In the Azure Portal, click **All resources**, and then click **20777blob\<your name\>\<the day\>**.

17. On the **20777blob\<your name\>\<the day\>** blade, under **BLOB SERVICE**, click **Blobs**.

18. On the **Blobs** blade, click **+ Container**.

19. In the **New container** dialog box, in the **Name** box, type **20777-mod2-blobs**.
...
22. Make a note of the **Connection string** value.
...
28. Under **Resource Group**, click **Use existing**, and then in the drop-down list, click **20777\_Mod02**.
...
31. In the Azure Portal, click **All resources**, and then click **20777-sql-\<your name\>-\<the day\>**.

32. On the **20777-sql-\<your name\>-\<the day\>** blade, click **Data Explorer**.

33. In the **SQL API** pane, click **New Database**.

34. On the **New Database** blade, in the **Database id** box, type **SalesData**, and then click **OK**.

35. On the **20777a-sql-\<your name\>-\<the day\>** blade, click **Keys**.
