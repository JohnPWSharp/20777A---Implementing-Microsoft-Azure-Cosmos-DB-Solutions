...
5. Edit the **resourceGroupLocation** variable to the name of your closest Azure location. 
...
11. Under **Allow access from**, click **All networks**, and then click **Save**.
12. On the **20777a-mod5-graph-\<*your initials and a day*\>** blade, click **Data Explorer**, and then click **New Database**.
13. On the **New Database** blade, in the **Database id** box, type **Adventure-Works**, and then click **OK**.
14. In the **GREMLIN API** pane, click **New Graph**.
15. On the **Add Graph** blade, under **Database id**, click **Use existing**, and then in the drop-down list, click **Adventure-Works**.
16. In the **Graph Id** box, type **recommendations**.
17. Under **Storage capacity**, click **Fixed (10 GB)**.
18. In the **Throughput (400 - 10,000 RU/s)** box, type **2500**, and then click **OK**.
19. On the **20777a-mod5-graph-\<*your initials and a day*\>** blade, under **Settings**, click **Keys**.
20. Make a note of the **PRIMARY KEY**, and **PRIMARY CONNECTION STRING** values.
...
8. In the **Collection** box, type **recommendations**.
9. In the **Collection Throughput** box, type **2500**.
10. In the **Id Field** box, type **id**, and then click **Next**.
11. On the **Advanced** page, click **Next**.
12. On the **Summary** page, click **Import**.
13. Verify that **98** records are imported.
...
- In Visual Studio 2017, on the **Web.config** tab, under the code:
    ...
    Replace **20777a-mod5-graph-\<your initials and a day\>** and **PRIMARY KEY**  with the values you used in the previous exercise.
...
1.  On the **Graph** tab, replace **g.V()** with **g.V("product id")** replacing **product id** with a **Product ID** number that was in your order, and then click **Execute Gremlin Query**.
2.  In Visual Studio 2017, on the **Debug** menu, click **Stop Debugging**.
