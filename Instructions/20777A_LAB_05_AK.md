...
13.  On the left panel, click **All resources**, and then click **20777a-mod5-sql-&lt;your initials and day&gt;**.
...
8. In the Azure portal, in the left pane, click **All resources**, and then click **20777a-mod5-graph-&lt;your initials and a day&gt;**.
9. On the **20777a-mod5-graph-&lt;your initials and a day&gt;** blade, click **Data Explorer**, and then click **New Database**.
10. On the **New Database** blade, in the **Database id** box, type **Adventure-Works**, and then click **OK**.
11. In the **GREMLIN API** pane, click **New Graph**.
12. On the **Add Graph** blade, under **Database id**, click **Use existing**, and then in the drop-down list, click **Adventure-Works**.
13. In the **Graph Id** box, type **recommendations**.
14. In the **Throughput (400 - 10,000 RU/s)** box, type **2500**, and then click **OK**.
15. On the **20777a-mod5-graph-&lt;your initials and a day&gt;** blade, under **Settings**, click **Keys**.
16. Make a note of the **PRIMARY KEY**, and **PRIMARY CONNECTION STRING** values.
17. At the end of the string, delete **ApiKind=Gremlin;**, and then add **Database=Adventure-Works;**.
